    ...
    const handleAddAdmin = async () => {
        try {
            ...
            if (user) {
                ...
                setEmail('');
                Swal.fire('Éxito', 'El usuario ha sido agregado como administrador.', 'success');
            } else {
                Swal.fire('Error', 'No se encontró ningún usuario con ese email.', 'error');
            }
        } catch (error) {
            setAddError(error.message);
            Swal.fire('Error', 'No se pudo agregar el usuario como administrador.', 'error');
        }
    };
            ...
            <div className='h-dvh overflow-x-auto'>
                ...
                <table className='min-w-full bg-white'>
                    ...
                    <tbody>
                        {admins.map(admin => (
                            <tr key={admin._id}>
                                <td className='py-2 px-4 border-b'>{admin.first_name} {admin.last_name}</td>
